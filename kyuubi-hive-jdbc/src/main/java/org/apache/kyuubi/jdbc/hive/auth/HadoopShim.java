...
public final class HadoopShim {
  ...
  private static final String HADOOP_CONF_CLASS = "org.apache.hadoop.conf.Configuration";
  private static final String AUTH_METHOD_CLASS =
      "org.apache.hadoop.security.SaslRpcServer$AuthMethod";
  private static final String AUTHENTICATION_METHOD_CLASS =
  ...
  static {
    try {
      ...
      Class.forName(HADOOP_CONF_CLASS);
      Class.forName(AUTH_METHOD_CLASS);
      Class.forName(AUTHENTICATION_METHOD_CLASS);
  ...
  public static class UserGroupInformation {
    ...
    private static Method getLoginUserMethod;
    private static Method getAuthenticationMethodMethod;
    private static Method getTokensMethod;
    private static Method setConfigurationMethod;
    ...
    static {
      if (hadoopClzAvailable) {
        try {
          ...
          getLoginUserMethod = ugiClz.getDeclaredMethod("getLoginUser");
          getAuthenticationMethodMethod = ugiClz.getDeclaredMethod("getAuthenticationMethod");
          getTokensMethod = ugiClz.getDeclaredMethod("getTokens");
          setConfigurationMethod =
              ugiClz.getDeclaredMethod("setConfiguration", Configuration.hadoopConfClz);
    ...
    /**
     * Forward to UserGroupInformation#getLoginUser()
     *
     * @return UserGroupInformation
     */
    public static Object getLoginUser() {
      ensureHadoopClzAvailable();
      try {
        return getLoginUserMethod.invoke(null);
      } catch (ReflectiveOperationException e) {
        throw new RuntimeException(e);
      }
    }
    ...
    /**
     * Forward to UserGroupInformation#getAuthenticationMethod()
     *
     * @param ugi UserGroupInformation
     * @return org.apache.hadoop.security.UserGroupInformation.AuthenticationMethod
     */
    public static Object getAuthenticationMethod(Object ugi) {
      ensureHadoopClzAvailable();
      requireClz(ugi, UGI_CLASS);
      try {
        return getAuthenticationMethodMethod.invoke(ugi);
      } catch (ReflectiveOperationException e) {
        throw new RuntimeException(e);
      }
    }
    ...
    /**
     * Forward to UserGroupInformation#setConfiguration(Configuration hadoopConf)
     *
     * @param hadoopConf org.apache.hadoop.conf.Configuration
     */
    public static void setConfiguration(Object hadoopConf) {
      ensureHadoopClzAvailable();
      requireClz(hadoopConf, HADOOP_CONF_CLASS);
      try {
  ...
  public static class AuthenticationMethod {
    ...
    private static Class<?> authenticationMethodClz;

    static {
      if (hadoopClzAvailable) {
        try {
          authenticationMethodClz = Class.forName(AUTHENTICATION_METHOD_CLASS);
        } catch (NoClassDefFoundError | ReflectiveOperationException e) {
          throw new RuntimeException(e);
        }
      }
    ...
    /**
     * Forward to Enum.valueOf(AuthenticationMethod.class, String value)
     *
     * @param string SIMPLE, KERBEROS, TOKEN, CERTIFICATE, KERBEROS_SSL, PROXY
     * @return org.apache.hadoop.security.UserGroupInformation.AuthenticationMethod
     */
    @SuppressWarnings({"unchecked", "rawtypes"})
    public static Object valueOf(String string) {
      ensureHadoopClzAvailable();
      return Enum.valueOf((Class) authenticationMethodClz, string.toUpperCase());
    }
  }

  public static class AuthMethod {
    private static Class<?> authMethodClz;
    private static Method getMechanismNameMethod;

    static {
      if (hadoopClzAvailable) {
        try {
          authMethodClz = Class.forName(AUTH_METHOD_CLASS);
          getMechanismNameMethod = authMethodClz.getDeclaredMethod("getMechanismName");
        } catch (NoClassDefFoundError | ReflectiveOperationException e) {
          throw new RuntimeException(e);
        }
      }
    ...
    /**
     * Forward to Enum.valueOf(AuthMethod.class, String value)
     *
     * @param string SIMPLE, KERBEROS, DIGEST, TOKEN, PLAIN
     * @return org.apache.hadoop.security.SaslRpcServer.AuthMethod
     */
    @SuppressWarnings({"unchecked", "rawtypes"})
    public static Object valueOf(String string) {
      ensureHadoopClzAvailable();
      return Enum.valueOf((Class) authMethodClz, string.toUpperCase());
    }

    /**
     * Forward to AuthMethod#getMechanismName
     *
     * @param authMethod org.apache.hadoop.security.SaslRpcServer.AuthMethod
     * @return mechanismName
     */
    public static String getMechanismName(Object authMethod) {
      ensureHadoopClzAvailable();
      requireClz(authMethod, AUTH_METHOD_CLASS);
      try {
        return (String) getMechanismNameMethod.invoke(authMethod);
      } catch (ReflectiveOperationException e) {
        throw new RuntimeException(e);
      }
    }
  ...
  public static class Configuration {
    private static Class<?> hadoopConfClz;
    private static Constructor<?> hadoopConfConstructor;
    private static Method hadoopConfSetMethod;

    static {
      if (hadoopClzAvailable) {
        try {
          hadoopConfClz = Class.forName(HADOOP_CONF_CLASS);
          hadoopConfConstructor = hadoopConfClz.getConstructor();
          hadoopConfSetMethod = hadoopConfClz.getDeclaredMethod("set", String.class, String.class);
        } catch (NoClassDefFoundError | ReflectiveOperationException e) {
          throw new RuntimeException(e);
        }
      }
    ...
    public static Object newInstance() {
      ensureHadoopClzAvailable();
      try {
        return hadoopConfConstructor.newInstance();
      } catch (ReflectiveOperationException e) {
        throw new RuntimeException(e);
      }
    }
    ...
    /**
     * Forward to Configuration#set(String k, String v)
     *
     * @param hadoopConf org.apache.hadoop.conf.Configuration
     * @param k key
     * @param v value
     */
    public static void set(Object hadoopConf, String k, String v) {
      ensureHadoopClzAvailable();
      requireClz(hadoopConf, HADOOP_CONF_CLASS);
      try {
        hadoopConfSetMethod.invoke(hadoopConf, k, v);
      } catch (ReflectiveOperationException e) {
        throw new RuntimeException(e);
      }
    }
  ...
  /** Return true if the UGI is already using the given authMethod. */
  public static boolean ugiHasCurrentAuthMethod(Object ugi, String sAuthMethod) {
    Object authMethod;
    try {
      authMethod = HadoopShim.AuthenticationMethod.valueOf(sAuthMethod);
    ...
    LOG.debug(
        "Current authMethod = {}", HadoopShim.UserGroupInformation.getAuthenticationMethod(ugi));
    return HadoopShim.UserGroupInformation.getAuthenticationMethod(ugi).equals(authMethod);
  }
